  ...
  <div>
    <ADescriptions bordered :column="2" size="middle" :label-style="{ width: '120px' }">
      ...
      <ADescriptionsItem label="短信模板">
        ...
        {{ entry.templateCode }}
        <ADivider type="vertical" />
        <DictTag :dict-object="systemSmsTemplateType" :value="entry.templateType!" />
      </ADescriptionsItem>
      ...
      <ADescriptionsItem label="发送状态">
        <DictTag :dict-object="systemSmsSendStatus" :value="entry.sendStatus!" />
      </ADescriptionsItem>
      <ADescriptionsItem label="接收状态">
        <DictTag :dict-object="systemSmsReceiveStatus" :value="entry.receiveStatus!" />
      </ADescriptionsItem>
