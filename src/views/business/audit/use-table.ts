...
export const columns: TableProps['columns'] = [
  ...
  { key: 'modelName', title: '申报名称', dataIndex: 'modelName' },
  // { key: 'name', title: '申请人姓名', dataIndex: 'name' },
...
export const useTable = (filterFormRef: Ref<FormInstance | undefined>) => {
  ...
  const { data, pending, execute } = useRequest(() => getList(route.query.userTaskId as any), {
    immediate: true
  })
